![GitHub License](https://img.shields.io/github/license/kslt/Mail-logs-from-Apache2)
![GitHub Stars](https://img.shields.io/github/stars/kslt/Mail-logs-from-Apache2)
![GitHub Forks](https://img.shields.io/github/forks/kslt/Mail-logs-from-Apache2)
<h1>✨ Mail logs from Apache2 ✨</h1>
Send a PDF generated file of the logs from Apache2 server, in a Linux Ubuntu Server environment.
<br>
THANKS TO:
